...
const BuyFullGurenty = () => {
    ...
    return (
        <div className='relative py-12'>
            <div className="bg-[#000] rounded-b-[50px] lg:rounded-b-[0px] h-[350px] md:h-[430px] xl:h-[350px] absolute z-[-1] w-full"></div>
            <div className="container pt-12 lg:pt-18 mx-auto px-0 lg:px-20 xl:px-62">
                <div className="pb-12">
                    <h2 className='text-3xl lg:text-lg text-white text-center font-[700] lg:font-normal'>Why With Us ?</h2>
                    <h3 className='px-12 lg:px-0 text-3xl lg:text-4xl text-white text-center font-[700] lg:font-[500] mt-2 lg:mt-4'>Buy with full guarantees</h3>
                </div>
                <div className="bg-white mx-6 lg:mx-0 px-4 lg:px-12 xl:px-6 2xl:px-12 py-6 xl:py-6 2xl:py-12 lg:py-20 rounded-lg lg:-mb-[300px] xl:mb-[-180px] 2xl:-mb-[200px] shadow-lg">
                    <div className="flex md:gap-6 xl:gap-0 flex-wrap justify-between text-black">
                        <div className="flex flex-col items-center md:border border-gray-200 rounded-lg overflow-hidden lg:shadow-sm p-6 w-full  md:w-[48%] xl:w-[22%]">
                        ...
                        </div> <div className="flex flex-col items-center md:border border-gray-200 rounded-lg overflow-hidden lg:shadow-sm p-6 w-full  md:w-[48%] xl:w-[22%]">
