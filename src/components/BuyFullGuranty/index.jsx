...
const BuyFullGurenty = () => {
    ...
    return (
        <div className='bg-[#000] py-12 mt-20 mb-12 lg:mb-62'>
            <div className="container mx-auto px-6 lg:px-20 2xl:px-32">
                ...
                <div className="bg-white px-4 lg:px-12 py-12 lg:py-20 rounded-lg lg:-mb-[300px] xl:-mb-[260px] shadow-lg">
                    <div className="flex gap-6 xl:gap-0 flex-wrap justify-between text-black">
                        <div className="flex flex-col items-center border border-gray-200 rounded-lg overflow-hidden shadow-sm p-6 w-full  md:w-[48%] xl:w-[22%]">
                            ...
                            <p className='text-lg font-[600] py-2'>Customer Service</p>
                            <p className='text-center tex-sm text-[#57637a] line-clamp-3'>We offer you the opportunity to return items free of charge, within 30 days of the delivery date.
                            </p>
                        </div>
                        <div className="flex flex-col items-center border border-gray-200 rounded-lg overflow-hidden shadow-sm p-6 w-full md:w-[48%] xl:w-[22%]">
                            <GrDeliver className='text-5xl' />
                            <p className='text-lg font-[600] py-2'>Free delivery</p>

                            <p className='text-center tex-sm text-[#57637a] line-clamp-4'>
                            ...
                            <p className='text-lg font-[600] py-2'>100% guarantee</p>
                            <p className='text-center tex-sm text-[#57637a] line-clamp-4'>
                            ...
                            <p className='text-lg font-[600] py-2'>Cash on delivery</p>
                            <p className='text-center tex-sm text-[#57637a] line-clamp-4'>
